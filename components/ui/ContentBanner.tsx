...
const ContentBanner = () => {
  return (
    <section
      ...
      pt-10 pb-20   overflow-hidden max-md:text-center "
    >
      <motion.div
        initial={{ rotate: -20 }}
        ...
        className="w-fit max-w-[1400px] max-md:hidden"
      >
        <Image src={line} alt="" className="ml-4"></Image>
      </motion.div>
      <div className="  flex  px-10 section flex-1  gap-10  max-md:flex-col max-md:px-10 max-sm:px-4 ">
        <div className=" max-w-[1240px] flex-1 flex flex-col gap-7 ">
          <p className="text-[#F89E52] font-[500] text-[20px]">
            Our Expertise is Your Success
          </p>
          <h2 className="text-[3.1rem] text-[#0B0B0B] font-[700] leading-[4rem]">
          ...
          <div className="flex gap-14 mt-10 max-md:items-center max-md:justify-center max-md:mb-10 max-sm:gap-8 max-sm:flex-col">
            <Button className="bg-accent-blue px-12 max-sm:px-20  py-5 text-white rounded-2xl text-[1.1rem]">
              View More
            </Button>
          </div>
          <motion.div
