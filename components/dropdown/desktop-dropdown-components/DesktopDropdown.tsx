...
const DeskopDropdown = ({ data }: { data: NavbarItemTypes }) => {
  return (
    <motion.div
      ...
      whileInView={"show"}
      exit="hidden"
      className="flex pb-10  shadow-lg border-t border-gray-100 absolute top-0 max-md:top-4 left-0 mt-24 max-md:mt-32 w-full bg-white px-10 flex-col gap-20 z-10"
    >
